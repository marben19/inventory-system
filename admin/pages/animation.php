<div class="container-fluid p-0">
    <h1 class="h3 mb-3"><strong>Animation</strong></h1>
    <div class="row">
        <div class="card">
            <div class="card-header d-flex justify-content-start">
                <button class="btn" id="add-product" style="background-color: #3B3F5C; background-image: linear-gradient(190deg, #3B3F5C 0%, #3A416F 100%); color: white;">Add Item to 2D Animation</button>
